...
VIALRGB_EFFECTS = [
    ...
    VialRGBEffect(29, "Pixel Rain"),
    VialRGBEffect(30, "Pixel Fractal"),
    VialRGBEffect(31, "Typing Heatmap"),
    VialRGBEffect(32, "Digital Rain"),
    VialRGBEffect(33, "Solid Reactive Simple"),
    VialRGBEffect(34, "Solid Reactive"),
    VialRGBEffect(35, "Solid Reactive Wide"),
    VialRGBEffect(36, "Solid Reactive Multiwide"),
    VialRGBEffect(37, "Solid Reactive Cross"),
    VialRGBEffect(38, "Solid Reactive Multicross"),
    VialRGBEffect(39, "Solid Reactive Nexus"),
    VialRGBEffect(40, "Solid Reactive Multinexus"),
    VialRGBEffect(41, "Splash"),
    VialRGBEffect(42, "Multisplash"),
    VialRGBEffect(43, "Solid Splash"),
    VialRGBEffect(44, "Solid Multisplash"),
]
